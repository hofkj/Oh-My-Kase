    ...
    return (
        <div className={styles.storeInfo}>
            <div className={styles.storeRow}>
                <span className={styles.map}><img src="/images/icon/map.png"/></span>
                <span className={styles.address}>{address}</span>
                <a href={mapLink} className={styles.mapLink}>지도 보기</a>
            </div>

            <div className={styles.storeRow} onClick={() => setIsExpanded(!isExpanded)}>
                <span className={styles.time_img}><img src="/images/icon/time.png"/></span>
            ...
            <div 
                ...
                style={{ maxHeight: isExpanded ? "160px" : "0", opacity: isExpanded ? 1 : 0 }}
            >
                {showContent && (
                    <>
            ...
            <div className={styles.storeRow}>
                <span className={styles.tel}><img src="/images/icon/tel.png"/></span>
