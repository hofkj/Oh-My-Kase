  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.tabContainer}>
        <div className={`${styles.tab} ${activeTab === "upcoming" ? styles.activeTab : ""}`} onClick={() => handleTabClick("upcoming")}>예정된 예약</div>
        <div className={`${styles.tab} ${activeTab === "completed" ? styles.activeTab : ""}`} onClick={() => handleTabClick("completed")}>완료된 예약</div>
        <div className={`${styles.tab} ${activeTab === "cancelled" ? styles.activeTab : ""}`} onClick={() => handleTabClick("cancelled")}>취소된 예약</div>
      </div>
